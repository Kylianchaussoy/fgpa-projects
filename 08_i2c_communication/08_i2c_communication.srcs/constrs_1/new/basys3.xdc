...
set_property -dict { PACKAGE_PIN V2    IOSTANDARD LVCMOS33 } [get_ports {is_burst}]
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports {clock_stretching}]
